...
import type { AlbumStatistics, FormattedAlbumStatistics } from '@/modules/client/interfaces/albums/album.statistic.interface';
import clientApi from "@/plugins/axios";
import albums from "@/common/data/albums";
import albumsService from "@/modules/client/services/albums/albums.service";
...
export const useAlbumStore = defineStore("album", {
    state: () => ({
        ...
        albumsByPartner: [] as AlbumInterface[], 
        loading: false,
    ...
    actions: {
        ...
        async fetchShow(slug: string){
            return await albumsService.detailAlbum(slug);
        },
        ...
        async fetchShowStatistic() {
            ...
            try {
                const response = await clientApi.get('/albums/statistics');
