<template>
  <div class="user-shell">
    ...
    <header class="topbar">
      ...
      <button class="edit-btn" @click="$router.push({ name: 'client.partner.artists.update', params: { id: route.params.id } })">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="16" height="16">
        ...
        <div class="preview-sticky">
           ...
           <div class="card system-card">
              <div class="sys-row">
                 ...
                 <span class="sys-val">{{ partnerName || 'System Primary' }}</span>
              </div>
              <div class="sys-row">
