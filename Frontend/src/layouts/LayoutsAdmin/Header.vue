  ...
  >
    <div class="flex items-center justify-between h-full px-6">
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="relative">
          ...
          >
            ...
            <div class="max-h-64 overflow-y-auto">
              <div v-for="notification in notifications" :key="notification.id" class="p-4 border-b border-gray-700 hover:bg-gray-700">
        ...
        <!-- Messages -->
        <button class="p-2 rounded-lg bg-gray-700 hover:bg-gray-600 text-gray-300 hover:text-white transition-colors duration-200">
