...
return new class extends Migration
{
    ...
    {
        // Thêm các type mới cho copyright report notifications
        // MySQL không hỗ trợ ALTER COLUMN ENUM trực tiếp qua Blueprint,
        // nên dùng raw SQL để modify ENUM
        DB::statement("
